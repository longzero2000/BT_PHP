...
<tr>
	<td align="center"><font color="blue"><h3>TÌM KIẾM CHỨC VỤ</h3></font></td>
</tr>
<tr>
	<td align="center">Chức vụ: <input type="text" name="tencv" size="30" 
				value="<?php if(isset($_GET['tencv'])) echo $_GET['tencv'];?>">
...
{
	if(empty($_GET['tencv'])) echo "<p align='center'>Vui lòng nhập tên sản phẩm</p>";
	else
	{
		$tencv=$_GET['tencv'];	
		require('ketnoi.php');
		$query="Select NHANVIEN.*, TENLOAINV, TENPHONG
		      ...
		      WHERE NHANVIEN.MALOAINV=LOAINV.MALOAINV AND NHANVIEN.MAPHONG=PHONGBAN.MAPHONG
					AND TENLOAINV like '%$tencv%'";
		$result=mysqli_query($dbc,$query);		
		if(mysqli_num_rows($result)<>0)
		{	$rows=mysqli_num_rows($result);
			echo "<div align='center'><b>Chức vụ: $tencv có $rows nhân viên</b></div>";
		...
		else echo "<div><font color='red'>Không tìm thấy nhân viên với chức vụ $tencv.</font></div>";
	}
}
?>
</center>
